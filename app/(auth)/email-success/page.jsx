    ...
    <>
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="font-medium">
          Si el correo que ingresaste es correcto, te enviaremos un correo con
          un enlace para reestablecer tu contraseña.
        </p>
        <p className="font-bold mt-5">Si no lo encuentras, revisa tu bandeja de spam.</p>
        <Link
          href="/sign-in"
