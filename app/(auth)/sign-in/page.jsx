          ...
          <div>
            ...
            <div className="mt-2 relative">
              <input
                ...
                className={`formulario ${formik.errors.identifier && formik.touched.identifier ? 'border-danger' : null}`}
          ...
          <div>
            ...
            <div className="mt-2 relative">
              ...
              <input
                ...
                className={`formulario ${formik.errors.password && formik.touched.password ? 'border-danger' : null}`}
