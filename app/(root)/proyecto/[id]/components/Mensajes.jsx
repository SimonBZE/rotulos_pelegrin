...
export const Mensajes = () => {
  ...
  return (
    <div>
      <div className="border-b border-stroke pt-5 px-5 max-h-[500px] bg-white rounded-xl mt-5 overflow-hidden overflow-y-scroll">
        <div>
          ...
          <div className="w-full p-4">
            {proyecto.attributes.mensajes.data.map((mensaje, index) => {
              const fecha = mensaje.attributes?.publishedAt
                ...
                : new Date();
              return (
                <div key={mensaje.id ? mensaje.id : index} className="mb-10">
      ...
      <div className="bottom-0 border-t border-stroke bg-white py-5 px-6 dark:border-strokedark dark:bg-boxdark">
        <form
