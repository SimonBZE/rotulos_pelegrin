...
const disenoSchema = Yup.object().shape({
  ...
  // imagenes: Yup.array().of(Yup.string()),
});
...
const validationSchema = Yup.object({
  ...
  contacto: Yup.string()
    ...
    .min(9, "El contacto debe tener exactamente 9 caracteres"),
  ...
  diseno: Yup.array().of(disenoSchema).required(),
});
              ...
              <div className="mt-5 px-5">
                ...
                <div className="flex justify-between items-center mt-2">
                  <div className="flex flex-col gap-2">
                    ...
                    />
                    {errors.cliente && (
                      <p className="text-danger">{errors.cliente}</p>
                    )}

                    <input
                      type="number"
                      className={`formulario ${
                        errors.contacto || (touched.contacto && errors.contacto)
                          ? "border-danger shadow-error"
                          : ""
                      }`}
