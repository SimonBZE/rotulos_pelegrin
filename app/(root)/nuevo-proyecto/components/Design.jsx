    ...
    <div className="rounded-md bg-[#6E5FFF30] mt-5 p-3">
        ...
        <div>
          ...
          <Field
            className={`formulario ${
              formik.touched.diseno?.[index]?.nombre &&
              formik.errors.diseno?.[index]?.nombre
                ? "border-danger border-2"
                : ""
            }`}
            type="text"
            name={`diseno[${index}].nombre`}
      ...
      <div className="flex items-center gap-2 justify-center mt-3">
        ...
        <div className="flex w-9/12 flex-col items-end">
          ...
          <Field
            className={`formulario ${
              formik.touched.diseno?.[index]?.unidades &&
              formik.errors.diseno?.[index]?.unidades
                ? "border-danger border-2"
                : ""
            }`}
            type="number"
