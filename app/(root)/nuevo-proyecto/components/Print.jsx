...
export const Print = ({
  ...
  useEffect(() => {
    ...
    const material =
      preciosServicios.impresion.vinilo[
        formik.values?.impresion?.[index].material
      ] || 0;
    const laminado =
      preciosServicios.impresion.laminado[
        formik.values?.impresion?.[index].laminacion
      ] || 0;
    const metros_cuadrados =
      formik.values?.impresion?.[index].ancho *
        formik.values?.impresion?.[index].alto || 0;
    const newTotal =
      (material + laminado) *
        metros_cuadrados *
        formik.values?.impresion?.[index].cantidad || 0;
    ...
    if (
      ...
      formik.setFieldValue(`impresion[${index}].material`, "3 a 5 años");
    }
    if (loading) {
      setLoading(false);
    }
        ...
        <div className="rounded-md bg-[#2FA7FF30] mt-5 p-3">
          ...
          <div className="flex items-center">
            ...
            <Field
              ...
              className={`formulario ml-2 ${
                formik.touched.impresion?.[index]?.nombre &&
                formik.errors.impresion?.[index]?.nombre
                  ? "errores"
                  : ""
              }`}
            ...
            <div>
              ...
              <Field
                ...
                className={`formulario w-full ${
                  formik.touched.impresion?.[index]?.ancho &&
                  formik.errors.impresion?.[index]?.ancho
                    ? "errores"
                    : ""
                }`}
            ...
            <div>
              ...
              <Field
                ...
                className={`formulario w-full ${
                  ...
                  formik.errors.impresion?.[index]?.alto
                    ? "errores"
                    : ""
                }`}
          ...
          <div className="flex flex-col mt-5">
            ...
            <Field
              ...
              className={`formulario ${
                formik.touched.impresion?.[index]?.material &&
                formik.errors.impresion?.[index]?.material
                  ? "errores"
                  : ""
              }`}
          ...
          <div className="flex flex-col mt-5">
            ...
            <Field
              ...
              className={`formulario ${
                formik.touched.impresion?.[index]?.laminacion &&
                formik.errors.impresion?.[index]?.laminacion
                  ? "errores"
                  : ""
              }`}
            >
              ...
              {Object.keys(preciosServicios.impresion.laminado).map(
                (opcion) => (
                  <option key={opcion} value={opcion}>
                    {opcion}
                  </option>
